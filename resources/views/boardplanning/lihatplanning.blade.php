    ...
    >
        ...
        <div class="flex-1 overflow-y-auto p-8 space-y-10 custom-scrollbar text-slate-800">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="bg-slate-50 p-4 rounded-3xl border border-slate-100">
                    <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-2">Priority</p>
                    <span 
                ...
                <div class="bg-slate-50 p-4 rounded-3xl border border-slate-100">
                    <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-2">Start</p>
            ...
            <div class="space-y-4">
                <div class="flex items-center gap-2 px-1">
                    ...
                    <h4 class="text-[11px] font-black text-slate-400 uppercase tracking-widest">Description & Content Brief</h4>
                </div>
                <div class="bg-white border border-slate-100 rounded-[2rem] p-8 shadow-sm">
                    <div class="prose prose-slate prose-sm max-w-none text-slate-600 leading-relaxed view-editor-content" x-html="viewingPlanning.description || '<p class=\'italic text-slate-400\'>No description available.</p>'">
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div class="flex items-center gap-2 px-1">
                    ...
                    <h4 class="text-[11px] font-black text-slate-400 uppercase tracking-widest">Responsible Team</h4>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <template x-for="(assign, index) in viewingPlanning.assigned" :key="index">
                        <div class="flex items-center gap-4 p-5 bg-slate-50 border border-slate-100 rounded-3xl">
                            ...
                            <div>
                                <h5 class="font-extrabold text-slate-800" x-text="assign.name || 'Unassigned'"></h5>
            ...
            <div class="space-y-4">
                <div class="flex items-center gap-2 px-1">
                    ...
                    <h4 class="text-[11px] font-black text-slate-400 uppercase tracking-widest">References & Moodboard</h4>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center gap-2 px-1">
                            ...
                            <h4 class="text-[11px] font-black text-slate-400 uppercase tracking-widest">Content Media Assets</h4>
                        </div>
                        <div class="bg-white border border-slate-100 rounded-3xl p-6 shadow-sm min-h-[160px] flex flex-col justify-center">
                            <template x-if="viewingPlanning.media_link && ['review', 'revisi', 'hold_on', 'approved', 'published'].includes(viewingPlanning.status)">
                                <div class="space-y-4">
                                    ...
                                    <div class="p-4 bg-slate-50 border border-dashed border-slate-200 rounded-2xl flex flex-col items-center text-center">
                                        ...
                                        <p class="text-[10px] font-bold text-slate-400 italic">Media asset link is ready to use.</p>
                                    </div>
                                </div>
                            </template>
                            ...
                            <template x-if="viewingPlanning.media_link && !['review', 'revisi', 'hold_on', 'approved', 'published'].includes(viewingPlanning.status)">
                                <div class="py-8 flex flex-col items-center justify-center text-center border-2 border-dashed border-slate-100 rounded-3xl bg-slate-50/50">
                                    ...
                                    <h5 class="text-xs font-bold text-slate-600">Download Not Yet Available</h5>
                                    <p class="text-[10px] text-slate-400 mt-2 px-6 leading-relaxed">Media assets can only be downloaded after the status moves to the <span class="text-indigo-500 font-black">Review</span> stage.</p>
                                </div>
                            </template>
                            ...
                            <template x-if="!viewingPlanning.media_link">
                                <div class="py-8 flex flex-col items-center justify-center text-center border-2 border-dashed border-slate-50 rounded-3xl">
                                    ...
                                    <p class="text-xs font-bold text-slate-400">No media assets uploaded yet.</p>
                                </div>
                            </template>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4" x-show="!['backlog', 'progress'].includes(viewingPlanning.status)" x-transition>
                        ...
                        <div class="bg-rose-50/30 border border-rose-100 rounded-[2rem] p-8 shadow-sm relative min-h-[160px]">
                            ...
                            <div class="relative z-10">
                                <p class="text-slate-600 leading-relaxed text-sm whitespace-pre-wrap italic" x-text="viewingPlanning.revision_note || 'No revision notes for this content yet.'"></p>
                            </div>
        ...
        <div class="px-8 py-6 border-t border-slate-100 bg-slate-50/50 flex items-center justify-between">
            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Content Planner CMS</p>
