    ...
    <div class="bg-white w-full max-w-xl rounded-[2.5rem] shadow-2xl border border-slate-200 overflow-hidden relative">
        ...
        <div class="px-8 py-6 border-b border-slate-100 flex items-center justify-between bg-white">
            <div class="flex items-center gap-4">
                <div class="w-12 h-12 rounded-2xl flex items-center justify-center text-white shadow-lg bg-emerald-500">
                    <i class="fa-solid fa-note-sticky text-xl"></i>
                </div>
                <div>
                    <h3 class="text-xl font-black text-slate-800 tracking-tight">Ide Konten Ramadhan</h3>
                    <div class="flex items-center gap-2 mt-0.5">
                        <i class="fa-solid fa-calendar-day text-[10px] text-slate-400"></i>
                        <p class="text-[10px] text-slate-500 font-bold uppercase tracking-widest">2024-03-15</p>
                    </div>
                </div>
            </div>
        ...
        <div class="p-8 space-y-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="px-3 py-1 rounded-full text-[9px] font-black text-white uppercase tracking-tighter bg-emerald-500">
                    Memo
                </div>
            </div>
            ...
            <div class="relative group">
                ...
                <div class="bg-slate-50/50 border border-slate-100 rounded-[2rem] p-6 min-h-[150px] relative overflow-hidden">
                    ...
                    <p class="text-slate-600 leading-relaxed text-sm whitespace-pre-wrap relative z-10">Buat konten tentang tips puasa sehat dan produktif selama bulan ramadhan. Fokus pada aspek kesehatan dan spiritual.</p>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between px-2">
                ...
                <p class="text-[9px] font-medium text-slate-400 italic">Terakhir diperbarui: {{ date('d/m/Y') }}</p>
            </div>
        </div>
        ...
        <div class="px-8 py-6 border-t border-slate-100 bg-slate-50/50 flex items-center justify-between">
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('notes.edit', $id ?? 1) }}" class="px-8 py-2.5 bg-indigo-600 text-white rounded-xl text-xs font-bold shadow-lg shadow-indigo-100 hover:bg-indigo-700 transition-all flex items-center gap-2">
