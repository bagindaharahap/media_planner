...
@section('title', 'Monitoring Instagram - PlannerX')
...
<div class="space-y-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-white p-6 md:p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-black text-slate-800 tracking-tight">Monitoring Instagram</h2>
                <p class="text-sm text-slate-500 mt-1">Pantau performa, interaksi, dan pertumbuhan akun Meta Anda.</p>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-gradient-to-br from-pink-500 to-purple-600 p-8 rounded-[2rem] text-white shadow-lg shadow-pink-500/20 relative overflow-hidden flex flex-col justify-center">
            ...
            <div class="relative z-10 flex items-center gap-5 mb-6">
                ...
                <div>
                    ...
                    <p class="text-pink-100 text-xs font-medium mt-1"><i class="fa-solid fa-circle-check text-blue-400"></i> Akun Bisnis Resmi</p>
                </div>
            </div>
        ...
        <!-- Metrik Detail Profil (Profile Insights) -->
        <div class="lg:col-span-2 grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div class="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm flex flex-col justify-center">
                ...
                <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Akun Dijangkau</p>
    ...
    <!-- 2. Grafik Interaksi & Pertumbuhan Instagram -->
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
            <div class="flex justify-between items-center mb-6">
                <h3 class="font-bold text-lg text-slate-800">Tren Interaksi (Engagement)</h3>
                <span class="text-xs font-bold text-slate-400 bg-slate-100 px-3 py-1 rounded-lg">30 Hari Terakhir</span>
            </div>
        ...
        <div class="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
            <div class="flex justify-between items-center mb-6">
                <h3 class="font-bold text-lg text-slate-800">Top Kota & Negara Audiens</h3>
    ...
    <div>
        <div class="flex items-center justify-between mb-6">
            <h3 class="font-bold text-xl text-slate-800 flex items-center gap-2">
                <i class="fa-solid fa-fire text-orange-500"></i> Postingan Feed & Reels Teratas
            </h3>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6" x-data>
            <template x-for="i in [1,2,3,4]" :key="i">
                <div class="bg-white rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden group hover:shadow-md transition">
                    ...
                    <div class="p-5">
                        <p class="text-xs text-slate-400 font-medium mb-3">2 Hari yang lalu</p>
        ...
        if(ctxIG) {
            ...
            new Chart(ctxIG, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Interaksi (Likes + Comments)', data: [12000, 15400, 14200, 18900],
